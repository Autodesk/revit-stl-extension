...
namespace BIM.STLExport
{
    public partial class STLExportForm : System.Windows.Forms.Form
    {
        ...
        public STLExportForm(Autodesk.Revit.UI.UIApplication revit)
        {
            ...
            ProjectUnit currentProjectUnit = m_Revit.ActiveUIDocument.Document.ProjectUnit;
            if (currentProjectUnit != null)
            {
               FormatOptions fo = currentProjectUnit.get_FormatOptions(UnitType.UT_Length);
               DisplayUnitType currentDut = fo.Units;
               ...
               foreach (DisplayUnitType dut in GetValidLengthDisplayUnits())
               {
                  if (currentDut == dut)
                     continue;
        ...
        IList<DisplayUnitType> GetValidLengthDisplayUnits()
        {
           IList<DisplayUnitType> lengths = new List<DisplayUnitType>();
           lengths.Add(DisplayUnitType.DUT_DECIMAL_INCHES);
           lengths.Add(DisplayUnitType.DUT_DECIMAL_FEET);
           lengths.Add(DisplayUnitType.DUT_MILLIMETERS);
           lengths.Add(DisplayUnitType.DUT_CENTIMETERS);
           lengths.Add(DisplayUnitType.DUT_DECIMETERS);
           lengths.Add(DisplayUnitType.DUT_METERS);
           return lengths;
        }
